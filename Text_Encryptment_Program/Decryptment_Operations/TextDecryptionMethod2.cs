namespace Text_Encryptment_Program.Decryptment_Operations
{
    public static class TextDecryptionMethod2
    {
        public static List<char> DecryptText(Dictionary<double, double> EncrKeyTable, List<char> encryptedText, int dictIndex)
        {
            ...
            if (EncrKeyTable.Keys.ElementAt(dictIndex) == 32 || EncrKeyTable.Keys.ElementAt(dictIndex) == 10 || EncrKeyTable.Keys.ElementAt(dictIndex) == 9)
            {
        ...
        public static List<char> DecryptText(int DecrChar, Dictionary<double, double> EncrKeyTable, List<char> encryptedText)   // Deryption of Spaces, Newlines and Tabs
        {
            List<char> workList = [.. encryptedText];
